...
func Load() Config {
	...
	c.PostServiceHost = cast.ToString(getOrReturnDefault("TEMPLATE_POST_SERVICE_HOST", "post_service"))
	c.PostServicePort = cast.ToInt(getOrReturnDefault("TEMPLATE_POST_SERVICE_PORT", "8080"))

	c.UserServiceHost = cast.ToString(getOrReturnDefault("TEMPLATE_USER_SERVICE_HOST", "user_service"))
	c.UserServicePort = cast.ToInt(getOrReturnDefault("TEMPLATE_USER_SERVICE_PORT", "5050"))
